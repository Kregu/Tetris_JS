export default class View {
    ...
    constructor(element, width, height, rows, columns) {
        ...
        this.playfieldInnerHight = this.playfieldHight - this.playfieldBorderWidth * 2;

        this.blockWidth = this.playfieldInnerWidth / columns;
        this.blockHight = this.playfieldInnerHight / rows;

        this.panelX = this.playfieldInnerWidth + 14;
        this.panelY = 0;
